...
(function () {
  ...
  if (heroEl) {
    ...
    var beats = [
      ...
      ['.hero__line:nth-child(2) > span', 380],
      ['.hero__line:nth-child(3) > span', 540],
  ...
  Array.prototype.forEach.call(accordions, function (acc) {
    ...
    var measure = function (panel) {
      // Read the natural height with the collapse temporarily lifted,
      // otherwise a panel that is already at height:0 reports the wrong value
      // in browsers that clamp scrollHeight to the box.
    ...
    // Web fonts change the line count, so remeasure once they have loaded
